...
public class Alert : MonoBehaviour
{
    ...
    public void ShowAlert()
    {
        for (int i = 0; i < ActionsManager.Instance.AllPlayersPhotonViews.Count; i++)
        {
            ...
            ActionTemplates.Instance.UpdatePatientLog($"{myPlayerData.UserName} Removed foreign object from {currentPatient.PatientData.SureName} {currentPatient.PatientData.LastName}");
        }
    }
}
